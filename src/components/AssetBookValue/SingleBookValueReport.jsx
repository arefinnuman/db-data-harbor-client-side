...
import { useCreateBookValueReportMutation } from "@/redux/bookValueReport/bookvValueReport";
...
const SingleBookValueReport = () => {
  ...
  const generateExcel = (responseData) => {
    const {
      assetBookValue,
      reportingDate,
      machineAgeInDays,
    ...
    const dataForExcelData = [
      {
        ...
        "First Deployment Date": formatDate(assetBookValue.firstDeploymentDate),
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-xl text-bold my-2">Create Single Book Value</h1>
...
export default SingleBookValueReport;
